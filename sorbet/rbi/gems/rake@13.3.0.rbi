...
#
# pkg:gem/rake#lib/rake/testtask.rb:35
class Rake::TestTask < ::Rake::TaskLib
  ...
  #
  # pkg:gem/rake#lib/rake/testtask.rb:86
  def initialize(name = T.unsafe(nil)); end

  # Create the tasks defined by this task lib.
  #
  # pkg:gem/rake#lib/rake/testtask.rb:108
  def define; end

  # Task prerequisites.
  #
  # pkg:gem/rake#lib/rake/testtask.rb:75
  def deps; end
  ...
  #
  # pkg:gem/rake#lib/rake/testtask.rb:72
  def description; end
  ...
  # pkg:gem/rake#lib/rake/testtask.rb:162
  def file_list; end

  # pkg:gem/rake#lib/rake/testtask.rb:158
  def file_list_string; end

  # pkg:gem/rake#lib/rake/testtask.rb:154
  def lib_path; end

  # List of directories added to $LOAD_PATH before running the
  # tests. (default is 'lib')
  #
  # pkg:gem/rake#lib/rake/testtask.rb:42
  def libs; end
  ...
  #
  # pkg:gem/rake#lib/rake/testtask.rb:66
  def loader; end
  ...
  #
  # pkg:gem/rake#lib/rake/testtask.rb:38
  def name; end
  ...
  # pkg:gem/rake#lib/rake/testtask.rb:138
  def option_list; end
  ...
  # is NONE)
  #
  # pkg:gem/rake#lib/rake/testtask.rb:50
  def options; end
  ...
  #
  # pkg:gem/rake#lib/rake/testtask.rb:58
  def pattern; end
  ...
  #
  # pkg:gem/rake#lib/rake/testtask.rb:69
  def ruby_opts; end
  ...
  # pkg:gem/rake#lib/rake/testtask.rb:147
  def ruby_opts_string; end

  # pkg:gem/rake#lib/rake/testtask.rb:173
  def ruby_version; end

  # pkg:gem/rake#lib/rake/testtask.rb:177
  def run_code; end
  ...
  #
  # pkg:gem/rake#lib/rake/testtask.rb:81
  def test_files=(list); end

  # True if verbose test output desired. (default is false)
  #
  # pkg:gem/rake#lib/rake/testtask.rb:45
  def verbose; end
  ...
  # (default is true)
  #
  # pkg:gem/rake#lib/rake/testtask.rb:55
  def warning; end
