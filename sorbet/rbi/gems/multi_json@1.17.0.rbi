...
module MultiJson
  ...
  #
  # pkg:gem/multi_json#lib/multi_json.rb:84
  def adapter=(new_adapter); end

  # pkg:gem/multi_json#lib/multi_json.rb:24
  def cached_options(*_arg0); end

  # pkg:gem/multi_json#lib/multi_json.rb:118
  ...
  #
  # pkg:gem/multi_json#lib/multi_json.rb:116
  def decode(string, options = T.unsafe(nil)); end

  # The default adapter based on what you currently
  # have loaded and installed.
  #
  # pkg:gem/multi_json#lib/multi_json.rb:42
  def default_adapter; end

  # The default adapter based on what you currently
  # have loaded and installed.
  #
  # pkg:gem/multi_json#lib/multi_json.rb:57
  def default_engine; end

  # pkg:gem/multi_json#lib/multi_json.rb:17
  ...
  # Encodes a Ruby object as JSON.
  #
  # pkg:gem/multi_json#lib/multi_json.rb:130
  ...
  # * <tt>:jr_jackson</tt> (JRuby only)
  #
  # pkg:gem/multi_json#lib/multi_json.rb:85
  ...
  # <tt>:adapter</tt> :: If set, the selected adapter will be used for this call.
  #
  # pkg:gem/multi_json#lib/multi_json.rb:108
  def load(string, options = T.unsafe(nil)); end

  # pkg:gem/multi_json#lib/multi_json.rb:87
  ...
  # * <tt>:jr_jackson</tt> (JRuby only)
  #
  # pkg:gem/multi_json#lib/multi_json.rb:79
  def use(new_adapter); end

  # Executes passed block using specified adapter.
  #
  # pkg:gem/multi_json#lib/multi_json.rb:133
  ...
  # pkg:gem/multi_json#lib/multi_json.rb:166
...
# pkg:gem/multi_json#lib/multi_json.rb:29
...
class MultiJson::AdapterError < ::ArgumentError
  ...
  class << self
    # pkg:gem/multi_json#lib/multi_json/adapter_error.rb:8
...
module MultiJson::Options
  ...
  # pkg:gem/multi_json#lib/multi_json/options.rb:41
  def handle_callable_options(options, *args); end

  # pkg:gem/multi_json#lib/multi_json/options.rb:45
...
module MultiJson::OptionsCache
  class << self
    ...
    #
    # pkg:gem/multi_json#lib/multi_json/options_cache.rb:43
    def dump; end
    ...
    # pkg:gem/multi_json#lib/multi_json/options_cache.rb:45
    def reset; end
  end
end

# pkg:gem/multi_json#lib/multi_json/options_cache.rb:3
class MultiJson::OptionsCache::Store
  # @return [Store] a new instance of Store
  #
  # pkg:gem/multi_json#lib/multi_json/options_cache.rb:12
  def initialize; end

  # pkg:gem/multi_json#lib/multi_json/options_cache.rb:23
  def fetch(key, &block); end

  # pkg:gem/multi_json#lib/multi_json/options_cache.rb:17
  def reset; end
end
...
class MultiJson::ParseError < ::StandardError
  ...
  class << self
    # pkg:gem/multi_json#lib/multi_json/parse_error.rb:11
