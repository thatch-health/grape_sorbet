...
# pkg:gem/simplecov-html#lib/simplecov-html.rb:15
...
class SimpleCov::Formatter::HTMLFormatter
  ...
  # pkg:gem/simplecov-html#lib/simplecov-html.rb:33
  ...
  # pkg:gem/simplecov-html#lib/simplecov-html.rb:79
  ...
  # pkg:gem/simplecov-html#lib/simplecov-html.rb:124
  def coverage_css_class(covered_percent); end

  # pkg:gem/simplecov-html#lib/simplecov-html.rb:120
  def covered_percent(percent); end

  # Returns a table containing the given source files
  #
  # pkg:gem/simplecov-html#lib/simplecov-html.rb:111
  def formatted_file_list(title, source_files); end

  # Returns the html for the given source_file
  #
  # pkg:gem/simplecov-html#lib/simplecov-html.rb:104
  ...
  # pkg:gem/simplecov-html#lib/simplecov-html.rb:157
  def link_to_source_file(source_file); end

  # pkg:gem/simplecov-html#lib/simplecov-html.rb:63
  def output_message(result); end

  # pkg:gem/simplecov-html#lib/simplecov-html.rb:75
  def output_path; end

  # pkg:gem/simplecov-html#lib/simplecov-html.rb:153
  def shortened_filename(source_file); end

  # pkg:gem/simplecov-html#lib/simplecov-html.rb:134
  def strength_css_class(covered_strength); end

  # Returns the an erb instance for the template of given name
  #
  # pkg:gem/simplecov-html#lib/simplecov-html.rb:71
  def template(name); end

  # pkg:gem/simplecov-html#lib/simplecov-html.rb:149
