...
module MultiJson
  ...
  #
  # pkg:gem/multi_json#lib/multi_json.rb:131
  def adapter=(new_adapter); end

  # pkg:gem/multi_json#lib/multi_json.rb:60
  ...
  #
  # pkg:gem/multi_json#lib/multi_json.rb:180
  ...
  #
  # pkg:gem/multi_json#lib/multi_json.rb:170
  ...
  #
  # pkg:gem/multi_json#lib/multi_json.rb:39
  ...
  #
  # pkg:gem/multi_json#lib/multi_json.rb:194
  ...
  # @return [String] JSON string
  #
  # pkg:gem/multi_json#lib/multi_json.rb:205
  ...
  # @return [Class] the current adapter class
  #
  # pkg:gem/multi_json#lib/multi_json.rb:110
  def engine; end
  ...
  # @return [Class] the loaded adapter class
  #
  # pkg:gem/multi_json#lib/multi_json.rb:140
  ...
  # @return [Object] parsed Ruby object
  #
  # pkg:gem/multi_json#lib/multi_json.rb:156
  ...
  #
  # pkg:gem/multi_json#lib/multi_json.rb:216
  ...
  # @return [Object] result of the block
  #
  # pkg:gem/multi_json#lib/multi_json.rb:231
  ...
  class << self
    ...
    # @return [Object] parsed Ruby object
    #
    # pkg:gem/multi_json#lib/multi_json.rb:171
    def decode(string, options = T.unsafe(nil)); end
    ...
    #
    # pkg:gem/multi_json#lib/multi_json.rb:86
    ...
    # @return [String] JSON string
    #
    # pkg:gem/multi_json#lib/multi_json.rb:206
    def encode(object, options = T.unsafe(nil)); end
    ...
    # @return [Object] result of the block
    #
    # pkg:gem/multi_json#lib/multi_json.rb:232
    def with_engine(new_adapter); end
  end
end
...
# @api public
#
# pkg:gem/multi_json#lib/multi_json.rb:66
...
class MultiJson::AdapterError < ::ArgumentError
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/adapter_error.rb:14
  ...
  class << self
    ...
    #
    # pkg:gem/multi_json#lib/multi_json/adapter_error.rb:26
...
# @api private
#
# pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:10
module MultiJson::AdapterSelector
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:31
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:86
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:63
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:108
  ...
  # @return [Class] the adapter class
  #
  # pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:134
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:49
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:75
  ...
  # @return [void]
  #
  # pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:96
...
# @api private
#
# pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:14
...
# @api private
#
# pkg:gem/multi_json#lib/multi_json/adapter_selector.rb:17
MultiJson::AdapterSelector::LOADERS = T.let(T.unsafe(nil), Hash)

# Legacy aliases for backward compatibility
#
# pkg:gem/multi_json#lib/multi_json/parse_error.rb:45
...
module MultiJson::Options
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/options.rb:60
  ...
  # @return [Hash] frozen empty hash
  #
  # pkg:gem/multi_json#lib/multi_json/options.rb:52
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/options.rb:44
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/options.rb:27
  ...
  # @return [Hash] resolved options hash
  #
  # pkg:gem/multi_json#lib/multi_json/options.rb:36
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/options.rb:82
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/options.rb:71
  def resolve_options(options, *_arg1, **_arg2, &_arg3); end
end

# @api private
#
# pkg:gem/multi_json#lib/multi_json/options.rb:9
...
# @api private
#
# pkg:gem/multi_json#lib/multi_json/options_cache.rb:9
module MultiJson::OptionsCache
  class << self
    ...
    #
    # pkg:gem/multi_json#lib/multi_json/options_cache.rb:78
    def dump; end
    ...
    #
    # pkg:gem/multi_json#lib/multi_json/options_cache.rb:84
    def load; end
    ...
    # @return [void]
    #
    # pkg:gem/multi_json#lib/multi_json/options_cache.rb:90
    def reset; end
  end
end
...
# @api private
#
# pkg:gem/multi_json#lib/multi_json/options_cache.rb:11
...
# @api private
#
# pkg:gem/multi_json#lib/multi_json/options_cache.rb:16
class MultiJson::OptionsCache::Store
  ...
  # @return [void]
  #
  # pkg:gem/multi_json#lib/multi_json/options_cache.rb:33
  def reset; end
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/options_cache.rb:63
...
# @api public
#
# pkg:gem/multi_json#lib/multi_json/parse_error.rb:7
class MultiJson::ParseError < ::StandardError
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/parse_error.rb:25
  ...
  #
  # pkg:gem/multi_json#lib/multi_json/parse_error.rb:14
  def data; end
  ...
  class << self
    ...
    #
    # pkg:gem/multi_json#lib/multi_json/parse_error.rb:39
...
class MultiJson::Version
  class << self
    ...
    #
    # pkg:gem/multi_json#lib/multi_json/version.rb:20
    def to_s; end
  end
end
