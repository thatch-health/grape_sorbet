...
# pkg:gem/dry-logic#lib/dry/logic.rb:6
module Dry; end

# pkg:gem/dry-logic#lib/dry/logic.rb:7
module Dry::Logic
  include ::Dry::Core::Constants

  class << self
    # pkg:gem/dry-logic#lib/dry/logic/rule.rb:7
    def Rule(*args, **options, &block); end

    # pkg:gem/dry-logic#lib/dry/logic.rb:10
    def loader; end
  end
end
...
module Dry::Logic::Appliable
  ...
  # pkg:gem/dry-logic#lib/dry/logic/appliable.rb:6
  def id; end
  ...
  # pkg:gem/dry-logic#lib/dry/logic/appliable.rb:26
  def to_ast; end
end
...
# pkg:gem/dry-logic#lib/dry/logic/builder.rb:38
class Dry::Logic::Builder::Context
  ...
  # @see Builder#call
  #
  # pkg:gem/dry-logic#lib/dry/logic/builder.rb:47
  def call(&_arg0); end
  ...
  class << self
    ...
    # pkg:gem/dry-logic#lib/dry/logic/builder.rb:40
    def allocate; end
...
# pkg:gem/dry-logic#lib/dry/logic/builder.rb:42
...
# pkg:gem/dry-logic#lib/dry/logic/builder.rb:9
Dry::Logic::Builder::IGNORED_OPERATIONS = T.let(T.unsafe(nil), Array)

# pkg:gem/dry-logic#lib/dry/logic/builder.rb:15
Dry::Logic::Builder::IGNORED_PREDICATES = T.let(T.unsafe(nil), Array)

# pkg:gem/dry-logic#lib/dry/logic/evaluator.rb:5
...
# pkg:gem/dry-logic#lib/dry/logic/evaluator.rb:36
class Dry::Logic::Evaluator::Attr < ::Dry::Logic::Evaluator
  # pkg:gem/dry-logic#lib/dry/logic/evaluator.rb:40
  def [](input); end

  # pkg:gem/dry-logic#lib/dry/logic/evaluator.rb:37
  def call(input); end
end

# pkg:gem/dry-logic#lib/dry/logic/evaluator.rb:29
class Dry::Logic::Evaluator::Key < ::Dry::Logic::Evaluator
  # pkg:gem/dry-logic#lib/dry/logic/evaluator.rb:33
  def [](input); end

  # pkg:gem/dry-logic#lib/dry/logic/evaluator.rb:30
  def call(input); end
end

# pkg:gem/dry-logic#lib/dry/logic/evaluator.rb:10
class Dry::Logic::Evaluator::Set
  ...
  # pkg:gem/dry-logic#lib/dry/logic/evaluator.rb:26
  def [](input); end
  ...
  class << self
    # pkg:gem/dry-logic#lib/dry/logic/evaluator.rb:15
    def new(paths); end
  end
end

# pkg:gem/dry-logic#lib/dry/logic/operations/abstract.rb:5
module Dry::Logic::Operations; end

# pkg:gem/dry-logic#lib/dry/logic/operations/abstract.rb:6
class Dry::Logic::Operations::Abstract
  ...
  # pkg:gem/dry-logic#lib/dry/logic/operations/abstract.rb:24
  def curry(*args); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/abstract.rb:20
  def id; end
  ...
  # pkg:gem/dry-logic#lib/dry/logic/operations/abstract.rb:36
  def to_ast; end

  # pkg:gem/dry-logic#lib/dry/logic/operations/abstract.rb:32
...
class Dry::Logic::Operations::And < ::Dry::Logic::Operations::Binary
  ...
  # pkg:gem/dry-logic#lib/dry/logic/operations/and.rb:38
  def [](input); end
  ...
  # pkg:gem/dry-logic#lib/dry/logic/operations/and.rb:17
  def operator; end

  # pkg:gem/dry-logic#lib/dry/logic/operations/and.rb:14
  def type; end
end

# pkg:gem/dry-logic#lib/dry/logic/operations/attr.rb:6
class Dry::Logic::Operations::Attr < ::Dry::Logic::Operations::Key
  # pkg:gem/dry-logic#lib/dry/logic/operations/attr.rb:11
  def type; end

  class << self
    # pkg:gem/dry-logic#lib/dry/logic/operations/attr.rb:7
...
class Dry::Logic::Operations::Binary < ::Dry::Logic::Operations::Abstract
  ...
  # pkg:gem/dry-logic#lib/dry/logic/operations/binary.rb:21
  def to_s; end
end
...
class Dry::Logic::Operations::Check < ::Dry::Logic::Operations::Unary
  ...
  # pkg:gem/dry-logic#lib/dry/logic/operations/check.rb:40
  def [](input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/check.rb:44
  def ast(input = T.unsafe(nil)); end
  ...
  # pkg:gem/dry-logic#lib/dry/logic/operations/check.rb:25
  def type; end

  class << self
    # pkg:gem/dry-logic#lib/dry/logic/operations/check.rb:9
    def new(rule, **options); end
  end
end

# pkg:gem/dry-logic#lib/dry/logic/operations/each.rb:6
class Dry::Logic::Operations::Each < ::Dry::Logic::Operations::Unary
  # pkg:gem/dry-logic#lib/dry/logic/operations/each.rb:25
  def [](arr); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/each.rb:11
  def call(input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/each.rb:7
  def type; end
end

# pkg:gem/dry-logic#lib/dry/logic/operations/implication.rb:6
class Dry::Logic::Operations::Implication < ::Dry::Logic::Operations::Binary
  # pkg:gem/dry-logic#lib/dry/logic/operations/implication.rb:26
  def [](input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/implication.rb:15
  def call(input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/implication.rb:11
  def operator; end

  # pkg:gem/dry-logic#lib/dry/logic/operations/implication.rb:7
  def type; end
end
...
class Dry::Logic::Operations::Key < ::Dry::Logic::Operations::Unary
  ...
  # pkg:gem/dry-logic#lib/dry/logic/operations/key.rb:46
  def [](hash); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/key.rb:50
  def ast(input = T.unsafe(nil)); end
  ...
  # pkg:gem/dry-logic#lib/dry/logic/operations/key.rb:58
  def to_s; end

  # pkg:gem/dry-logic#lib/dry/logic/operations/key.rb:31
  def type; end

  class << self
    # pkg:gem/dry-logic#lib/dry/logic/operations/key.rb:21
    def evaluator(name); end

    # pkg:gem/dry-logic#lib/dry/logic/operations/key.rb:11
    def new(rules, **options); end
  end
end

# pkg:gem/dry-logic#lib/dry/logic/operations/negation.rb:6
class Dry::Logic::Operations::Negation < ::Dry::Logic::Operations::Unary
  # pkg:gem/dry-logic#lib/dry/logic/operations/negation.rb:15
  def [](input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/negation.rb:11
  def call(input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/negation.rb:7
  def type; end
end

# pkg:gem/dry-logic#lib/dry/logic/operations/or.rb:6
class Dry::Logic::Operations::Or < ::Dry::Logic::Operations::Binary
  # pkg:gem/dry-logic#lib/dry/logic/operations/or.rb:28
  def [](input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/or.rb:12
  def call(input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/or.rb:10
  def operator; end

  # pkg:gem/dry-logic#lib/dry/logic/operations/or.rb:7
  def type; end
end

# pkg:gem/dry-logic#lib/dry/logic/operations/set.rb:6
class Dry::Logic::Operations::Set < ::Dry::Logic::Operations::Abstract
  # pkg:gem/dry-logic#lib/dry/logic/operations/set.rb:20
  def [](input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/set.rb:24
  def ast(input = T.unsafe(nil)); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/set.rb:11
  def call(input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/set.rb:28
  def to_s; end

  # pkg:gem/dry-logic#lib/dry/logic/operations/set.rb:7
  def type; end
end
...
class Dry::Logic::Operations::Unary < ::Dry::Logic::Operations::Abstract
  ...
  # pkg:gem/dry-logic#lib/dry/logic/operations/unary.rb:18
  def to_s; end
end

# pkg:gem/dry-logic#lib/dry/logic/operations/xor.rb:6
class Dry::Logic::Operations::Xor < ::Dry::Logic::Operations::Binary
  # pkg:gem/dry-logic#lib/dry/logic/operations/xor.rb:16
  def [](input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/xor.rb:20
  def ast(input = T.unsafe(nil)); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/xor.rb:12
  def call(input); end

  # pkg:gem/dry-logic#lib/dry/logic/operations/xor.rb:10
  def operator; end

  # pkg:gem/dry-logic#lib/dry/logic/operations/xor.rb:7
  def type; end
end

# pkg:gem/dry-logic#lib/dry/logic/operators.rb:5
module Dry::Logic::Operators
  # pkg:gem/dry-logic#lib/dry/logic/operators.rb:9
  def &(other); end

  # pkg:gem/dry-logic#lib/dry/logic/operators.rb:24
  def >(other); end

  # pkg:gem/dry-logic#lib/dry/logic/operators.rb:19
  def ^(other); end

  # pkg:gem/dry-logic#lib/dry/logic/operators.rb:6
  def and(other); end

  # pkg:gem/dry-logic#lib/dry/logic/operators.rb:11
  def or(other); end

  # pkg:gem/dry-logic#lib/dry/logic/operators.rb:21
  def then(other); end

  # pkg:gem/dry-logic#lib/dry/logic/operators.rb:16
  def xor(other); end

  # pkg:gem/dry-logic#lib/dry/logic/operators.rb:14
  def |(other); end
end

# pkg:gem/dry-logic#lib/dry/logic/predicates.rb:12
...
# pkg:gem/dry-logic#lib/dry/logic/predicates.rb:16
module Dry::Logic::Predicates::Methods
  ...
  # pkg:gem/dry-logic#lib/dry/logic/predicates.rb:209
...
class Dry::Logic::Result
  ...
  # pkg:gem/dry-logic#lib/dry/logic/result.rb:44
  def to_ast; end

  # pkg:gem/dry-logic#lib/dry/logic/result.rb:52
  def to_s; end

  # pkg:gem/dry-logic#lib/dry/logic/result.rb:36
  def type; end

  private

  # pkg:gem/dry-logic#lib/dry/logic/result.rb:58
  def visit(ast); end

  # pkg:gem/dry-logic#lib/dry/logic/result.rb:72
  def visit_and(node); end

  # pkg:gem/dry-logic#lib/dry/logic/result.rb:91
  def visit_hint(node); end

  # pkg:gem/dry-logic#lib/dry/logic/result.rb:87
  def visit_not(node); end

  # pkg:gem/dry-logic#lib/dry/logic/result.rb:77
  def visit_or(node); end

  # pkg:gem/dry-logic#lib/dry/logic/result.rb:62
  def visit_predicate(node); end

  # pkg:gem/dry-logic#lib/dry/logic/result.rb:82
  def visit_xor(node); end
end

# pkg:gem/dry-logic#lib/dry/logic/result.rb:6
Dry::Logic::Result::SUCCESS = T.let(T.unsafe(nil), T.untyped)

# pkg:gem/dry-logic#lib/dry/logic/rule.rb:15
class Dry::Logic::Rule
  ...
  # pkg:gem/dry-logic#lib/dry/logic/rule.rb:87
  def ast(input = T.unsafe(nil)); end

  # pkg:gem/dry-logic#lib/dry/logic/rule.rb:64
  def bind(object); end

  # pkg:gem/dry-logic#lib/dry/logic/rule.rb:60
  def curry(*new_args); end

  # pkg:gem/dry-logic#lib/dry/logic/rule.rb:75
  ...
  # pkg:gem/dry-logic#lib/dry/logic/rule.rb:52
  def type; end

  # pkg:gem/dry-logic#lib/dry/logic/rule.rb:79
  def with(new_opts); end

  private

  # pkg:gem/dry-logic#lib/dry/logic/rule.rb:93
  def args_with_names(*input); end

  class << self
    # pkg:gem/dry-logic#lib/dry/logic/rule.rb:41
    def build(predicate, args: T.unsafe(nil), arity: T.unsafe(nil), **options); end

    # pkg:gem/dry-logic#lib/dry/logic/rule.rb:28
    def interfaces; end

    # pkg:gem/dry-logic#lib/dry/logic/rule.rb:32
...
class Dry::Logic::Rule::Interface < ::Module
  ...
  # pkg:gem/dry-logic#lib/dry/logic/rule/interface.rb:127
  def curried_args; end

  # pkg:gem/dry-logic#lib/dry/logic/rule/interface.rb:107
  def define_application; end

  # pkg:gem/dry-logic#lib/dry/logic/rule/interface.rb:91
  def define_constant_application; end

  # pkg:gem/dry-logic#lib/dry/logic/rule/interface.rb:74
  def define_constructor; end

  # pkg:gem/dry-logic#lib/dry/logic/rule/interface.rb:52
  def name; end

  # pkg:gem/dry-logic#lib/dry/logic/rule/interface.rb:38
  def unapplied; end
...
# pkg:gem/dry-logic#lib/dry/logic/rule/interface.rb:7
Dry::Logic::Rule::Interface::SPLAT = T.let(T.unsafe(nil), Array)

# pkg:gem/dry-logic#lib/dry/logic/rule/predicate.rb:6
class Dry::Logic::Rule::Predicate < ::Dry::Logic::Rule
  # pkg:gem/dry-logic#lib/dry/logic/rule/predicate.rb:27
  def ast(input = T.unsafe(nil)); end

  # pkg:gem/dry-logic#lib/dry/logic/rule/predicate.rb:15
  def name; end

  # pkg:gem/dry-logic#lib/dry/logic/rule/predicate.rb:30
  def to_ast(input = T.unsafe(nil)); end

  # pkg:gem/dry-logic#lib/dry/logic/rule/predicate.rb:19
  def to_s; end

  # pkg:gem/dry-logic#lib/dry/logic/rule/predicate.rb:11
  def type; end

  class << self
    # pkg:gem/dry-logic#lib/dry/logic/rule/predicate.rb:7
    def specialize(arity, curried, base = T.unsafe(nil)); end
  end
end
...
class Dry::Logic::RuleCompiler
  ...
  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:16
  def visit(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:60
  def visit_and(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:35
  def visit_attr(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:21
  def visit_check(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:44
  def visit_each(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:75
  def visit_implication(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:30
  def visit_key(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:26
  def visit_not(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:65
  def visit_or(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:48
  def visit_predicate(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:40
  def visit_set(node); end

  # pkg:gem/dry-logic#lib/dry/logic/rule_compiler.rb:70
  def visit_xor(node); end
end
